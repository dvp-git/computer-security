...
def RSA_(key_size,file_name):
    ...
    return f"\n Filename: {file_name}:{size_repr} KeyGen Time :{key_gen_time} ns,Enc Time: {enc_time} ns, Dec Time: {dec_time} ns ,Encryption speed per byte:{per_byteenc}ns, Decryption speed per byte:{per_bytedec}ns"
